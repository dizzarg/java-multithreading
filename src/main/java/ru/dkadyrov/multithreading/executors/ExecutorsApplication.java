package ru.dkadyrov.multithreading.executors;
...
public class ExecutorsApplication {
    ...
    public static void singleTreadScheduledExecutor() {
    ...
    public static void workStealingThreadPool() {
